<template>
    <div class="container mx-auto px-4">
        <div class="rounded shadow-lg py-6 border border-gray-300 lg:w-3/5 mx-auto">
            <h1 class="font-bold text-4xl text-gray-800 px-6 mb-6 sm:mb-4 leading-tight">{{ history.name }}</h1>
            ...
            <section class="py-6 border-b border-gray-200">
                <div class="px-6 flex">
                    ...
                    <div class="w-2/3">
                        <InertiaLink class="bg-indigo-700 inline-block text-white text-lg font-bold px-8 py-3 rounded" :href="$route('history.play', history)">
                            Join Game
                        </InertiaLink>
                    </div>
                </div>
                    ...
                    <div class="w-2/3">
                        <div class="mb-4">
                            ...
                            <small class="text-xs text-gray-600 mt-1">
                                Send this link to the person you want to invite to your game. This link is valid for <strong>24 hour</strong>. Every time you refresh this page, you receive a new invitation link.
                            </small>
                        </div>
                    </div>
                </div>
